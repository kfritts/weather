...
//start of arrays 
  ...
  $diys = array(
    ...
    $rain = array(
      ...
      '<a data-pin-do="embedUser" data-pin-board-width="400" data-pin-scale-height="240" data-pin-scale-width="80" href="https://www.pinterest.com/search/pins/?q=diy%2520rain&rs=typed&term_meta%5B%5D=diy%257Ctyped&term_meta%5B%5D=rain%257Ctyped"></a>',
      
      '<a data-pin-do="embedUser" data-pin-board-width="400" data-pin-scale-height="240" data-pin-scale-width="80" href="https://www.pinterest.com/search/pins/?q=activities%2520to%2520do%2520the%2520rain&rs=typed&term_meta%5B%5D=activities%2520to%2520do%2520the%2520rain%257Ctyped"></a>',
      
      '<a data-pin-do="embedUser" data-pin-board-width="400" data-pin-scale-height="240" data-pin-scale-width="80" href="https://www.pinterest.com/search/pins/?q=diy%2520umbrella&rs=typed&term_meta%5B%5D=diy%257Ctyped&term_meta%5B%5D=umbrella%257Ctyped"></a>',
      
      '<a data-pin-do="embedUser" data-pin-board-width="400" data-pin-scale-height="240" data-pin-scale-width="80" href="https://www.pinterest.com/search/pins/?rs=ac&len=2&q=diy%2520rain%2520boots&eq=diy%2520rain&etslf=11098&term_meta%5B%5D=diy%257Cautocomplete%257Cundefined&term_meta%5B%5D=rain%257Cautocomplete%257Cundefined&term_meta%5B%5D=boots%257Cautocomplete%257Cundefined"></a>',
      
      '<a data-pin-do="embedUser" data-pin-board-width="400" data-pin-scale-height="240" data-pin-scale-width="80" href="https://www.pinterest.com/search/pins/?q=indoor%2520diy&rs=typed&term_meta%5B%5D=indoor%257Ctyped&term_meta%5B%5D=diy%257Ctyped"></a>'
...
if($temp < 50){
  $the_diys = $diys[0][rand(0, 4)];
  
}else if ($temp >50){
  $the_diys = $diys[1][rand (0,4)];
}


if($temp>80){
  echo $diys[0][rand(0, 4)];
} else{
  echo $diys[1][rand (0,4)];
}
